export default function Contact() {
    return (
        <div className="min-h-screen bg-base-white dark:bg-base-black dark:text-base-white">
            {/* Hero Section */}
            <div className="bg-base-white dark:bg-base-black dark:text-base-white py-16">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    {/* Contact Form */}
                    <div className="bg-base-white dark:bg-base-black dark:text-base-white rounded-lg shadow-sm p-8">
